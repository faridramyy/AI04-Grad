...
export function GameModal({ onClose }) {
  ...
  useEffect(() => {
    const cookieStress = parseFloat(getCookie("initial_stress_score"));
    const validScore = isNaN(cookieStress)
      ? 0.5
                ...
                <>
                  ...
                  {showInfo && (
                    <div className="p-4 bg-[#1E293B]/50 border border-gray-700 mt-4 rounded-md text-sm text-gray-300">
                      This AI-driven game adapts based on your stress level.
                      Choose wisely — your decisions impact the next scenario.
                    </div>
                  )}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between space-x-4">
                      <button
                        ...
                        className="px-5 py-2.5 rounded-md bg-gray-800 text-white hover:bg-gray-700"
                      >
                        Finish
                      </button>
                      <button
