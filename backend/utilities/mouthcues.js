...
const audioPath =
  "C:/graduation project folder/AI04-Grad/backend/audios/intro_0.wav"; // Use forward slashes // adjust path before running

const savePath =
  "C:/graduation project folder/AI04-Grad/backend/audios/lipsync_intro_1.json"; // adjust path before running
